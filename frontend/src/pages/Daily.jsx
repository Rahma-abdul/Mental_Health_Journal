                ...
                <div className="container">
                    <div className="entry">
                        <div className="header">
                            <input type='text' className= 'title' placeholder="Today's Title" ></input>
                            <input type='date' className='date' value={date} onChange={(e) => setDate(e.target.value)} ></input>
                        </div>

                            <textarea className="body" placeholder="How is your day going?" rows={15}></textarea>
                    ...
                    <div className="side">
                        <div className="selectmood">
                            ...
                            <div className="moods">
                                ...
                                <img
                                    ...
                                    src={icon}
                                    alt="mood"
                                    className={`icon ${mood === index ? 'selected' : ''}`}
                        ...
                        <div className="music">
                            ...
                            <img src={playlist} alt="music" className="playlist"></img>
